...
# ╔═╡ e7cbbd00-a7d3-4760-9ae0-2998c7c11019
...
begin
	l = 0.025            #¡Cambia el valor asignado a l, ejecuta la celda
...
# ╔═╡ a4057291-e5ba-4c9d-b245-ab49a8ade7c6
@bind d Slider(.05:0.05:2, default=0.5)

# ╔═╡ 84fff41c-214b-499b-ac6b-5ac8774e256d
d

# ╔═╡ 9383d6aa-aef0-43f8-b00e-88430958d54f
begin
	plot(sin,-π:d:π, title="Funciones trigonométricas", xlabel="x", ylabel="y", label= "sen(x)")
	plot!(cos, -π:d:π, label="cos(x)")
end
...
# ╔═╡ d8612ac3-b1c1-487f-98c9-a500dd6ca4f7
begin
	tiro = @animate for t in 0:0.1:final
		y(t)= altura + (r*sin(θ)*t) - ((1/2)*(9.81)*t^2)
		plot(y.(range(0,final, step= 0.1)*t), title="Tiro parabólico", xaxis=("Tiempo"), yaxis=("Posición"), label="partícula", linestyle=:dash, marker=:dash)
	end
	gif(tiro, "tiroparabolico.gif", fps = 5)
end
...
#Tu código (comentado) va aquí :D
function grafica_de_la_particula(altura, r, θ)
	t_final=(2*r)/9.81
	begin
	tiro = @animate for t in 0:0.1:final
		y(t)= altura + (r*sin(θ)*t) - ((1/2)*(9.81)*t^2)
...
# ╔═╡ f05823bc-0676-4b4e-872b-228747a253a7
grafica_de_la_particula(50, 20, 60)
