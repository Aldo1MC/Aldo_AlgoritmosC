...
# ╔═╡ 16ed866a-85cb-44de-9119-a02f55568679
n = 3

# ╔═╡ 20344a94-0bbc-4a53-9087-04815e9c8e39
m = tamañoDePaso(5,10,n)
...
function arregloUniforme(t0,tf,N,h)
	...
	for i in 1:1:N
		tiempo_i = t0 + (i*h)
		push!(arreglo,tiempo_i)
	end
	return arreglo
end

# ╔═╡ cead0616-feb1-4eb0-a4e6-dd0bf711b941
a = arregloUniforme(5,10,n, m)
...
function paso_euler(ti,xti,g,h)
	aproximacion = xti + h*(g(ti,xti))
end

# ╔═╡ a2545e54-f389-4243-9f5b-854eefcdb98f
g(t,x) = t + x

# ╔═╡ 6f60d48a-0ee8-4cff-bba6-8d6763311647
paso_euler(5,1,g,m)
...
function euler(g,xt0,t)
	arreglo=[]
	tamaño = length(t)
	aprox = paso_euler(t[1], xt0, g, m)
	push!(arreglo, aprox)
	for i in 2:1:tamaño
		aprox = paso_euler(t[i], aprox, g, m)
		push!(arreglo, aprox)
	end
	return arreglo
end

# ╔═╡ f5cfd801-9311-4148-ad06-b37313155e2c
euler(g,1,a)
...
# ╔═╡ 99b4c60c-1d23-4f07-bde6-e8497b1bbb23
function paso_euler2(ti,xti,g,h)
	aproximacion = xti + h*(g(ti))
end

# ╔═╡ 020cd585-ee12-44da-855d-d1f7aaf9baaf
function euler2(g,xt0,t)
	arreglo=[]
	tamaño = length(t)
	aprox = paso_euler2(t[1], xt0, g, 1.6)
	push!(arreglo, aprox)
	for i in 2:1:tamaño
		aprox = paso_euler2(t[i], aprox, g, 1.6)
		push!(arreglo, aprox)
	end
	return arreglo
end

# ╔═╡ ad8eb4df-ba0e-49ad-8660-67f93ffabd4f
euler2(p, 1, a)
