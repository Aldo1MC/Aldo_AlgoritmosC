...
# ╔═╡ 95cc3cbf-ee51-42a4-8550-2c67da4e1e53
...
# ╔═╡ 412be106-e587-4b13-978c-15a9d0979708
rand()

# ╔═╡ 812b65bc-6386-4880-bb6b-503327caba82
rand(Int)

# ╔═╡ 02c5cfee-2821-4364-b5ce-a3e1cb481b5f
rand(Bool)
...
# ╔═╡ 26e11980-c39b-4c20-ad20-33599072fccf
rand(n)

# ╔═╡ 89ac0d8c-bc2b-4b6f-816c-669a7592aabe
rand(Int,n)

# ╔═╡ 63ce6816-8f25-4fa9-87af-7ff90db0e452
rand(Bool,n)
...
# ╔═╡ fdba9ec3-72eb-45b8-a464-a264f50b9bd7
begin
	a = 5
	b = 6
	arreglo = []
...
# ╔═╡ 8119c493-8d9a-4808-b31c-07361254e3b1
c = aleatorioUniforme(a,b)

# ╔═╡ 0a9a15de-b062-48f9-bb46-0eecf1bb3ffc
push!(arreglo,c)

# ╔═╡ 9f945953-b300-4ac6-adf8-57fd16dcb0f2
arreglo
...
# ╔═╡ 46010cd5-b33c-4493-9acd-3480a3d54af4
histogram(arreglo, bins=a:b, legend=false)
...
# ╔═╡ 682c24c2-742f-4a4b-9b59-20ea34860b70
function unPaso()
	(-1)^rand(Bool)
end

# ╔═╡ a1913091-e9cd-4afc-9ae0-975ffdce10d3
unPaso()
...
# ╔═╡ 0575942b-81c1-47fe-8ac0-37dc74a9886f
variosPasos(10)
...
# Tu código (comentado) va aquí :)
function caminataAleatoria(pos0, n)
	posicion = [pos0]
	i = variosPasos(n)
	for x in 1:1:n
		w = posicion[x] + i[x]
...
# ╔═╡ a0db97eb-cf38-4792-9a19-d924d9985025
m = caminataAleatoria(5, 5)
...
# Tu código (comentado) va aquí :)
function graficaCaminata(arreglo)
	u = length(arreglo)
return plot(0:u,arreglo, title="Caminata Aleatoria", xlabel="pasos", ylabel="posición")
end

# ╔═╡ ec1b0929-c16d-4448-83b8-87966315c2ca
graficaCaminata(m)
...
julia_version = "1.8.5"
manifest_format = "2.0"
project_hash = "74a0239a1f9b5b862a239512b32df7b46c0e5fc1"
